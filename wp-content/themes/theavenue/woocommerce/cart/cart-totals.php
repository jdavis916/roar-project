...
<div class="col-md-5 col-xl-4"><div class="cart-totals-w">
	...
	<div class="cart-totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
		...
		<h2 class="cart-totals_h"><?php esc_html_e( 'Cart Totals', 'avenue' ); ?></h2>

		<table class="cart-totals-lst" cellspacing="0">

			<tr class="cart-subtotal">
				<th class="cart-totals-lst-el_h"><?php esc_html_e( 'Subtotal', 'avenue' ); ?></th>
				<td class="cart-totals-lst-el_cnt" data-title="<?php esc_attr_e( 'Subtotal', 'avenue' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
			</tr>
			...
			<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
				...
				<tr>
					<th class="cart-totals-lst-el_h"><?php esc_html_e( 'Shipping', 'avenue' ); ?></th>
					<td class="cart-totals-lst-el_cnt" data-title="<?php esc_attr_e( 'Shipping', 'avenue' ); ?>"><?php woocommerce_shipping_calculator(); ?></td>
				</tr>
			...
			if (wc_tax_enabled() && 'excl' === WC()->cart->tax_display_cart) {
				...
				$estimated_text  = WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping()
					? sprintf( ' <small>(' . esc_html__( 'estimated for %s', 'avenue' ) . ')</small>', WC()->countries->estimated_for_prefix( $taxable_address[0] ) . WC()->countries->countries[ $taxable_address[0] ] )
					: '';
			...
			<tr>
				<th class="cart-totals-lst-el_h __bottom"><?php esc_html_e( 'Total', 'avenue' ); ?></th>
				<td class="cart-totals-lst-el_cnt __bottom" data-title="<?php esc_attr_e( 'Total', 'avenue' ); ?>"><span class="cart-totals-lst-el_price"><?php wc_cart_totals_order_total_html(); ?></span></td>
			</tr>
		...
		<div class="cart-totals-btn-w">
			...
			<input type="submit" class="cart-totals-btn __update __light" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'avenue' ); ?>" form="cart-form">
