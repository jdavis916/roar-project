 ...
 * @since 1.0
 */
function bdpp_render_post_list( $atts, $content = null )  {
	...
	$shortcode_designs 				= bdpp_post_list_designs();
	...
	if ( $query->have_posts() ) {
			...
			bdpp_generate_style( $style_id, 'shortcode', 'grid', 'bdp_post_list', $atts );

			bdpp_get_template( 'list/loop-start.php', $atts );
			...
			while ( $query->have_posts() ) : $query->the_post();
				...
				// Include Dsign File
				bdpp_get_template( "list/{$design}.php", $atts );

			endwhile;

			bdpp_get_template( 'list/loop-end.php', $atts );
...
// Post Grid Shortcode
add_shortcode( 'bdp_post_list', 'bdpp_render_post_list' );