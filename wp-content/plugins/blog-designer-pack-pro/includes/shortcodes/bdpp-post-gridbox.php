 ...
 * @since 1.0
 */
function bdpp_render_post_gridbox( $atts, $content = null )  {
	...
	$shortcode_designs 				= bdpp_post_gridbox_designs();
	...
	if ( $query->have_posts() ) {		
			...
			bdpp_generate_style( $style_id, 'shortcode', 'grid', 'bdp_post_gridbox', $atts );
			
			bdpp_get_template( 'gridbox/loop-start.php', $atts );
			...
			while ( $query->have_posts() ) : $query->the_post();
	            ...
	            // Include Dsign File
				bdpp_get_template( "gridbox/{$design}.php", $atts );

			endwhile;

			bdpp_get_template( 'gridbox/loop-end.php', $atts );
...
add_shortcode( 'bdp_post_gridbox', 'bdpp_render_post_gridbox' );