 ...
 * Taxonomy Template 5
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/taxonomy/slider/design-5.php
 *
	...
	<div class="bdpp-term-inner bdpp-clearfix">
		<div class="bdpp-term-img-wrapper <?php echo $lazy_cls; ?>" <?php echo $image_style; ?>>
			...
			<div class="term-heading-main">
				...
				if( $show_count ) { ?>
				<div class="bdpp-term-count"><?php echo $term_data->count; ?> <?php esc_html_e('Posts', 'blog-designer-pack'); ?></div>
				<?php } ?>
			</div>
			<?php }
