 ...
 * Timeline Template 5
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/timeline/design-5.php
 * 
...
<div class="bdpp-timeline <?php echo $wrp_cls; ?>">
	...
	<div class="bdpp-tmln-icon-content">
		<div class="bdpp-tmln-icon-outer">
			<span class="bdpp-tmln-icon-inner"><?php echo bdpp_post_format_html( $format ); ?></span>
		</div>
	</div>

	<div class="bdpp-tmln-content">
		<div class="bdpp-tmln-content-inner">
			<?php if ( $feat_img ) { ?>
			...
			<?php } ?>
			<div class="bdpp-tmln-bottom-content">
