 ...
 * Timeline Template 8
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/timeline/design-8.php
 * 
...
<div class="bdpp-timeline <?php echo $wrp_cls; ?>">
	<div class="bdpp-tmln-icon"><?php echo bdpp_post_format_html( $format ); ?></div>
