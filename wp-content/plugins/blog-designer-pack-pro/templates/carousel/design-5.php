 ...
 * Carousel Template 5
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/carousel/design-5.php
 * 
...
<div class="bdpp-post-slide <?php echo $wrp_cls; ?>" <?php echo $hash_listener; ?>>
	<div class="bdpp-post-carousel-content">
		...
		if($show_category || $show_date || $show_author || $show_comments || $sharing) { ?>
