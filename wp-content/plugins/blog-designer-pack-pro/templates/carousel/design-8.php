 ...
 * Carousel Template 8
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/carousel/design-8.php
 * 
...
<div class="bdpp-post-slide <?php echo $wrp_cls; ?>" <?php echo $hash_listener; ?>>
	<div class="bdpp-post-carousel-content">
		...
		if($show_category || $show_author || $show_comments || $sharing) { ?>
