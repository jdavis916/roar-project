 ...
 * Carousel Template 4
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/carousel/design-4.php
 * 
	...
	<div class="bdpp-post-carousel-content">
		...
		<div class="bdpp-post-img-bg">
			<a href="<?php echo esc_url( $post_link ); ?>" target="<?php echo $link_behaviour; ?>">
				...
				<?php }
				if( $format == 'video' ) { echo bdpp_post_format_html( $format ); } ?>
			</a>
		</div>
		<?php } ?>
		<div class="bdpp-post-content-block bdpp-clearfix">
			...
			<div class="bdpp-post-cats bdpp-clearfix"><?php echo $cate_name; ?></div>
			<?php } ?>
