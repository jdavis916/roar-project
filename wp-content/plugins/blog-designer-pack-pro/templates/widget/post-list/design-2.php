<?php
/**
 * Post List Widget Template 2
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/widget/post-list/design-2.php
 * 
	...
	<div class="bdpp-widget-content">
		...
		<div class="bdpp-post-list-left bdpp-col-s-5 bdpp-columns">
			<div class="bdpp-post-img-bg">
				...
				<span class="bdpp-post-count"><?php echo $count; ?></span>
			</div>
		</div>
		<?php } ?>
