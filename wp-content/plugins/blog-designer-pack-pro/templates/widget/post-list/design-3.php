<?php
/**
 * Post List Widget Template 3
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/widget/post-list/design-3.php
 * 
...
<div class="bdpp-post-widget-main <?php echo $wrp_cls; ?> bdpp-clearfix">
	<div class="bdpp-widget-content">
		<?php if( $count == 1 && $feat_img ) { ?>
			<div class="bdpp-post-list-right bdpp-col-s-12 bdpp-columns">
