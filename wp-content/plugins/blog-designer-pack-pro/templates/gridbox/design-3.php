 ...
 * GridBox Template 3
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/gridbox/design-3.php
 * 
	...
	<div class="bdpp-post-gridbox bdpp-post-gridbox-left bdpp-col-2 bdpp-columns <?php echo $wrp_cls; ?>">
		<div class="bdpp-post-grid-content">
			...
			<div class="bdpp-post-img-link">	
				...
				<div class="bdpp-post-img-bg" style="<?php echo $height_css; ?> background-image:url(<?php echo esc_url( $feat_img ); ?>);"></div>
