 ...
 * GridBox Template 5
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/gridbox/design-5.php
 * 
...
$wrp_cls	.= ( $count % 2  == 0 ) ? ' bdpp-first' : '';

if( $count == 1 ) { ?>
<div class="bdpp-post-gridbox bdpp-post-gridbox-top bdpp-col-1 bdpp-columns <?php echo $wrp_cls; ?>">
...
<?php } else {
	$media_size	= ( empty($media_size) ) ? 'bdpp-medium' : $media_size;
	$feat_img	= bdpp_get_post_feat_image( $post->ID, $media_size, true );
?>
<div class="bdpp-post-gridbox bdpp-post-gridbox-bottom bdpp-col-2 bdpp-columns <?php echo $wrp_cls; ?>">
	<div class="bdpp-post-grid-content">
		<?php if ( $feat_img ) { ?>
