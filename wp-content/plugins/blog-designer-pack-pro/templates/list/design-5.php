 ...
 * List Template 5
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/list/design-5.php
 * 
...
<div class="bdpp-post-list-main <?php echo $wrp_cls; ?>">
	<div class="bdpp-post-list-content bdpp-clearfix">
		<?php if ( $feat_img ) { ?>
			<div class="bdpp-post-list-left bdpp-col-xl-8 bdpp-columns">
		...
		<div class="bdpp-post-list-right <?php if ( !$feat_img ) { echo 'bdpp-col-xl-12'; } else { echo 'bdpp-col-xl-4'; } ?> bdpp-columns">
