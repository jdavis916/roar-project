 ...
 * Masonry Template 6
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/masonry/design-6.php
 * 
...
<div class="bdpp-post-grid <?php echo $wrp_cls; ?>">
	<div class="bdpp-post-grid-content">
		...
		<div class="bdpp-post-content-inner">
			...
			<?php if($show_date || $show_category || $show_author || $show_comments || $sharing) { ?>
