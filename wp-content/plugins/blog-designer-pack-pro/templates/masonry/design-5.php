 ...
 * Masonry Template 5
 *
 * This template can be overridden by copying it to yourtheme/blog-designer-pack-pro/masonry/design-5.php
 * 
...
<div class="bdpp-post-grid <?php echo $wrp_cls; ?>">
	<div class="bdpp-post-grid-content">
		...
		if($show_date || $show_category || $show_author || $show_comments || $sharing) { ?>
